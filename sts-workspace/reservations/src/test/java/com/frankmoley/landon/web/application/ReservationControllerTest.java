...
public class ReservationControllerTest {
        ...
        //private static final DateFormat DATE_FORMAT= new SimpleDateFormat(patter:"yyyy-MM-dd");
        
        //@Test
        @Test
        public void getReservations() throws Exception{
            Date date = DATE_FORMAT.parse("2017-01-01");
            //Date date = DATE_FORMAT.parse(source: "2017-01-01");
            ...
            this.mockMvc.perform(get("/reservation?date=2017-01-01")).andExpect(status().isOk()).andExpect(content().string(containsString("Test.JUnit")));
        }
